if (typeof kotlin === 'undefined') {
  throw new Error("Error loading module 'cmapi-multi-js'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'cmapi-multi-js'.");
}
this['cmapi-multi-js'] = function (_, Kotlin) {
  'use strict';
  ...
  MpUUID.prototype.getRandomUUID = function () {
    function s(n) {
  ...
  function GeoAltitudeMode() {
    this.altitudeMode_xc64hp$_0 = IGeoAltitudeMode$AltitudeMode$ABSOLUTE_getInstance();
  }
  ...
  function GeoCamera() {
    GeoBase.call(this);
    this.altitudeMode_vpfkxv$_0 = IGeoAltitudeMode$AltitudeMode$ABSOLUTE_getInstance();
  ...
  function GeoLookAt() {
    GeoBase.call(this);
    this.altitudeMode_h9n6k0$_0 = IGeoAltitudeMode$AltitudeMode$ABSOLUTE_getInstance();
  ...
  function IGeoAirControlMeasure$Attribute$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoAirControlMeasure.Attribute.' + name);
    }
  }
  ...
  function IGeoAirControlMeasure$AcmType_initFields() {
    ...
    IGeoAirControlMeasure$AcmType$ROUTE_instance = new IGeoAirControlMeasure$AcmType('ROUTE', 0);
    IGeoAirControlMeasure$AcmType$CYLINDER_instance = new IGeoAirControlMeasure$AcmType('CYLINDER', 1);
    IGeoAirControlMeasure$AcmType$ORBIT_instance = new IGeoAirControlMeasure$AcmType('ORBIT', 2);
    IGeoAirControlMeasure$AcmType$POLYGON_instance = new IGeoAirControlMeasure$AcmType('POLYGON', 3);
    IGeoAirControlMeasure$AcmType$RADARC_instance = new IGeoAirControlMeasure$AcmType('RADARC', 4);
    IGeoAirControlMeasure$AcmType$POLYARC_instance = new IGeoAirControlMeasure$AcmType('POLYARC', 5);
    IGeoAirControlMeasure$AcmType$TRACK_instance = new IGeoAirControlMeasure$AcmType('TRACK', 6);
    IGeoAirControlMeasure$AcmType$CURTAIN_instance = new IGeoAirControlMeasure$AcmType('CURTAIN', 7);
  }
  ...
  function IGeoAirControlMeasure$AcmType$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoAirControlMeasure.AcmType.' + name);
    }
  }
  ...
  function IGeoAltitudeMode$AltitudeMode$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoAltitudeMode.AltitudeMode.' + name);
    }
  }
  ...
  function IGeoFillStyle$FillPattern$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoFillStyle.FillPattern.' + name);
    }
  }
  ...
  function IGeoLabelStyle$Typeface$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoLabelStyle.Typeface.' + name);
    }
  }
  ...
  function IGeoLabelStyle$Justification$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoLabelStyle.Justification.' + name);
    }
  }
  ...
  function IGeoMilSymbol$Modifier$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoMilSymbol.Modifier.' + name);
    }
  }
  ...
  function IGeoMilSymbol$SymbolStandard$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoMilSymbol.SymbolStandard.' + name);
    }
  }
  ...
  function IGeoRenderable$PathType$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant org.cmapi.primitives.interfaces.IGeoRenderable.PathType.' + name);
    }
  }
  ...
  var package$interfaces = package$primitives.interfaces || (package$primitives.interfaces = {});
  package$interfaces.IGeoAirControlMeasure = IGeoAirControlMeasure;
  ...
  package$interfaces.IGeoAltitudeMode = IGeoAltitudeMode;
  package$interfaces.IGeoBase = IGeoBase;
  ...
  package$interfaces.IGeoMilSymbol = IGeoMilSymbol;
  package$interfaces.IGeoPath = IGeoPath;
  package$interfaces.IGeoPoint = IGeoPoint;
  package$interfaces.IGeoPolygon = IGeoPolygon;
  package$interfaces.IGeoPosition = IGeoPosition;
  package$interfaces.IGeoPositionGroup = IGeoPositionGroup;
  package$interfaces.IGeoPositionHistory = IGeoPositionHistory;
  package$interfaces.IGeoRectangle = IGeoRectangle;
